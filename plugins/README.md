...
Third-party and reference AISec plugins live under this directory. The **Plugin Manager** (`aisec-plugin-host`) discovers manifests recursively and executes plugins in a sandboxed subprocess.
...
2. Edit `aisec-plugin.toml` — set `plugin_type`, `language`, capabilities, and hooks.
