...
use aisec_payload::PayloadDatabase;
use aisec_planner::AttackPlan;

use crate::convert::{attack_to_payload_category, record_to_attack_payload};
use crate::error::GeneratorResult;
use crate::types::{GeneratorMode, GeneratorStats, PromptPayloads};

pub fn generate_static_pack(plan: &AttackPlan) -> GeneratorResult<PromptPayloads> {
...
mod tests {
    ...
    fn static_pack_respects_disabled_tests() {
        ...
        let pack = generate_static_pack(&plan).unwrap();
