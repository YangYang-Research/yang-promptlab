      ...
      <div className="yazg-chat-page__layout">
        <Card className="detail-section yazg-chat-page__sidebar">
          ...
          <p className="detail-section__hint">
            ...
            AnalyzeEndpointAgent / AttackPlanAgent / AgenticAttackExecutionAgent / SequentialAttackExecutionAgent / ReflectionAgent / GeneratePromptAgent / RecommendAgent / SummaryAgent / JudgeCoordinatorAgent.
